...
Description: "FHIR QuestionnaireResponse filled out by Florence Bennett during routine GP check-up"
* questionnaire = "http://fhir.ch/ig/ch-ig/Questionnaire/community-facing-questionnaire"
* status = #in-progress
